export const WORDLE_ANSWERS: string[] = [
  // English common
  "ABOUT", "ALERT", "ARGUE", "BEACH", "BEGIN", "BLACK", "BLOOD", "BOARD", "BRAIN", "BREAD",
  "BREAK", "BROWN", "BUILD", "BUYER", "CATCH", "CAUSE", "CHAIN", "CHAIR", "CHART", "CHIEF",
  "CHILD", "CLASS", "CLEAN", "CLEAR", "CLOCK", "CLOSE", "COACH", "COAST", "COUNT", "COVER",
  "CREAM", "CRIME", "CROSS", "CROWD", "CROWN", "DANCE", "DEATH", "DEPTH", "DOUBT", "DRAFT",
  "DREAM", "DRINK", "DRIVE", "EARTH", "EMPTY", "ENEMY", "ENTRY", "ERROR", "EVENT", "EXACT",
  "FAITH", "FAULT", "FIELD", "FIGHT", "FINAL", "FIRST", "FLOOR", "FORCE", "FRAME", "FRANK",
  "FRONT", "FRUIT", "GLASS", "GRANT", "GRASS", "GREEN", "GROUP", "GUIDE", "HEART", "HEAVY",
  "HORSE", "HOTEL", "HOUSE", "IMAGE", "INDEX", "INPUT", "ISSUE", "JUDGE", "KNIFE", "LARGE",
  "LAUGH", "LAYER", "LEARN", "LEAVE", "LEVEL", "LIGHT", "LIMIT", "LOCAL", "LUNCH", "MAGIC",
  "MAJOR", "MARCH", "MATCH", "METAL", "MODEL", "MONEY", "MONTH", "MOTOR", "MOUTH", "MUSIC",
  "NIGHT", "NOISE", "NORTH", "NOVEL", "NURSE", "OFFER", "ORDER", "OTHER", "OWNER", "PANEL",
  "PAPER", "PARTY", "PEACE", "PHASE", "PHONE", "PIECE", "PILOT", "PITCH", "PLACE", "PLAIN",
  "PLANE", "PLANT", "PLATE", "POINT", "POUND", "POWER", "PRESS", "PRICE", "PRIDE", "PRIZE",
  "PROOF", "QUEEN", "QUICK", "QUIET", "RADIO", "RAISE", "RANGE", "RATIO", "REACH", "REPLY",
  "RIGHT", "RIVER", "ROUGH", "ROUND", "ROUTE", "RUGBY", "SCALE", "SCENE", "SCOPE", "SCORE",
  "SENSE", "SHAPE", "SHARE", "SHEEP", "SHEET", "SHIFT", "SHIRT", "SHOCK", "SHOOT", "SHORT",
  "SIGHT", "SKILL", "SLEEP", "SMILE", "SMITH", "SMOKE", "SOLID", "SOUND", "SOUTH", "SPACE",
  "SPEED", "SPEND", "SPORT", "SQUAD", "STAFF", "STAGE", "START", "STATE", "STEAM", "STEEL",
  "STOCK", "STONE", "STORE", "STUDY", "STUFF", "STYLE", "SUGAR", "TABLE", "TASTE", "THEME",
  "THING", "THINK", "THUMB", "TIGER", "TITLE", "TOTAL", "TOUCH", "TOUGH", "TOWER", "TRACK",
...
export const VALID_GUESSES: string[] = [
  ...WORDLE_ANSWERS,
  // Add some more generic 5-letter words so users can guess them
  ...
  "BRIDE", "BRIEF", "BRINE", "BRING", "BRINK", "BRISK", "BROAD", "BROIL", "BROKE", "BROOD",
  "BROOK", "BROOM", "BROTH", "BROWN", "BRUNT", "BRUSH", "BRUTE", "BUDDY", "BUDGE", "BUGGY",
  "BUGLE", "BUILD", "BUILT", "BULGE", "BULKY", "BULLY", "BUNCH", "BUNNY", "BURLY", "BURNT",
  "BURST", "BUSED", "BUSHY", "BUTCH", "BUTTE", "BUYER", "BYLAW", "CABAL", "CABIN", "CABLE",
  ...
  "CHUTE", "CIDER", "CIGAR", "CINCH", "CIRCA", "CIVIC", "CLASS", "CLEAN", "CLEAR", "CLEAT",
  "CLEFT", "CLERK", "CLICK", "CLIFF", "CLIMB", "CLING", "CLINK", "CLOAK", "CLOCK", "CLONE",
  "CLOSE", "CLOTH", "CLOUD", "CLOUT", "CLOVE", "CLOWN", "CLUCK", "COACH", "COAST", "COCOA",
  "COMET", "COMIC", "COMMA", "CONCH", "CONDO", "CONIC", "COPSE", "CORAL", "CORNY", "COSTS",
  "COUGH", "COULD", "COUNT", "COURT", "COVER", "COVET", "COWER", "COYPU", "CRACK", "CRAFT",
  ...
  "GAGGY", "GAMER", "GAMMA", "GAMUT", "GASSY", "GAUDY", "GAUGE", "GAUNT", "GAUZE", "GAVEL",
  ...
  "HEFTY", "HEIST", "HELIX", "HELLO", "HENCE", "HERON", "HILAR", "HINGE", "HIPPO", "HIPPY",
  ...
  "IRATE", "IRONY", "ISLET", "ISSUE", "ITCHY", "ITEMA", "IVORY", "JABOT", "JACKS", "JADED",
  "JAUNT", "JAZZY", "JELLY", "JERKY", "JESTS", "JETTY", "JEWEL", "JIFFY", "JOINT", "JOIST",
  ...
  "LODGE", "LOGIC", "LOGIN", "LOOPI", "LOOSE", "LORRY", "LOSER", "LOUSE", "LOUSY", "LOVER",
  "LOWER", "LOWLY", "LOYAL", "LUCID", "LUCKY", "LUMEN", "LUMPY", "LUNAR", "LUNCH", "LUNGE",
  "LUPUS", "LURCH", "LUREX", "LURID", "LUSTY", "LYING", "LYMPH", "LYRIC", "MACAW", "MACHO",
  ...
  "NYMPH", "OAKEN", "OASIS", "OBESE", "OCCUR", "OCEAN", "OCTAL", "OCTET", "ODDER", "ODDLY",
  "OFFAL", "OFFER", "OFTEN", "OLDEN", "OLDER", "OLIVE", "OMBUD", "OMEGA", "ONION", "ONSET",
  "OPERA", "OPINE", "OPIUM", "OPTIC", "ORBIT", "ORDER", "ORGAN", "OTHER", "OTTER", "OUGHT",
  "OUNCE", "OUTDO", "OUTER", "OUTGO", "OVALT", "OVARY", "OVATE", "OVERT", "OVINE", "OVOID",
  ...
  "PIAZZ", "PIETY", "PIGGY", "PILOT", "PINCH", "PINEY", "PINKY", "PINTO", "PIPER", "PIQUE",
  "PITCH", "PITHY", "PIVOT", "PIXEL", "PIXIE", "PIZZA", "PLACE", "PLAID", "PLAIN", "PLAIT",
  "PLANE", "PLANK", "PLANT", "PLATE", "PLAZA", "PLEAD", "PLEAT", "PLIED", "PLIER", "PLUCK",
  "PLUMB", "PLUMP", "PLUNK", "PLUSH", "POESY", "POINT", "POISE", "POKER", "POLAR", "POLKA",
  "POLYP", "POOCH", "POPPY", "PORCH", "POSER", "POSIT", "POSSE", "POUCH", "POUND", "POUTY",
  "POWER", "PRANK", "PRAWN", "PREEN", "PRESS", "PRICE", "PRICK", "PRIDE", "PRIER", "PRIME",
  ...
  "RECUT", "REDOX", "REDUX", "REEDY", "REFER", "REFIT", "REGAL", "REHAB", "REIGN", "RELAX",
  ...
  "SHAPE", "SHARD", "SHARE", "SHARK", "SHARP", "SHAVE", "SHAWL", "SHEAR", "SHEAF", "SHEIK",
  "SHELF", "SHELL", "SHIED", "SHIFT", "SHILL", "SHINE", "SHINY", "SHIRE", "SHIRK", "SHIRT",
  ...
  "SKUNK", "SLACK", "SLAIN", "SLANG", "SLANT", "SLASH", "SLATE", "SLATT", "SLEEK", "SLEEP",
  ...
  "STASH", "STATE", "STATU", "STAVE", "STEAD", "STEAK", "STEAL", "STEAM", "STEED", "STEEL",
  ...
  "VOCAL", "VODKA", "VOGUE", "VOICE", "VOILA", "VOMIT", "VOTER", "VOUCH", "VOWEL", "VOYAG",
...
export function getDailyWordNumber(): number {
  const start = new Date('2026-01-01T00:00:00Z');
  const today = new Date();
  today.setHours(0, 0, 0, 0); // Need to use local time midnight for the 'daily' reset
