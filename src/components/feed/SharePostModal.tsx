...
export const SharePostModal: React.FC<Props> = ({ post, author, onClose, onShare }) => {
              ...
              >
                ...
                >
                  <div 
                    ...
                    style={{ background: author?.avatarUrl ? undefined : getAvatarColor(author?.displayName || '?') }}
                  >
                    {author?.avatarUrl ? (
                ...
                <div className="px-4 py-3">
                  {post.content && (
                    <p 
                      className="text-[13px] leading-relaxed whitespace-pre-wrap break-words line-clamp-5"
                      style={{ color: 'var(--color-text-main)' }}
                    >
                      {post.content}
                    </p>
